...
//           const delay = Math.min(10000, Math.pow(2, newCount) * 1000);
...
//             </span>
//           </div>
//           <div className="px-3 py-1 bg-indigo-500/10 border border-indigo-500/30 rounded-full text-indigo-400 text-[10px] font-bold uppercase tracking-widest">
...
//                     metrics.total_e2e_ms < 2000
//                       ? "text-emerald-400"
//                       : "text-rose-400"
//                   }`}
//                 >
//                   {metrics.total_e2e_ms || 0}ms
//                 </span>
//               </div>
//             </div>
//           </div>
    ...
    <div className="min-h-screen bg-[#0a0c12] text-slate-200 font-sans p-4 md:p-8">
      ...
      <main className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <aside className="space-y-6">
          ...
          {/* RESTORED FULL DYNAMIC BILLING ENGINE */}
          <CostEstimationPanel
            telemetry={telemetry}
            isVADActive={isVADActive}
          />
